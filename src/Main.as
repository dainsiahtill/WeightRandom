package
{
	...
	public class Main extends Sprite 
	{
		...
		private function init(e:Event = null):void 
		{
			...
			var weightList:Vector.<com.titan.arithmetic.Weight>  = com.titan.arithmetic.WeightUtil.calculateWeights(list, "hot");
			for (var i:int = 0; i < weightList.length; i++) 
			{
				var weight:com.titan.arithmetic.Weight = weightList[i];
			...
			for (var j:int = 0; j < 1000000; j++) 
			{
				...
				var matchWeight:com.titan.arithmetic.Weight = com.titan.arithmetic.WeightUtil.matchWeight(rndValue, weightList);
